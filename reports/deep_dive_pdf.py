...
from tools.val_db import REAL_ESTATE_OPPORTUNITIES, BUSINESS_OPPORTUNITIES
from tools.llm_pdf_compiler import generate_stock_deep_dive, generate_real_estate_deep_dive, generate_startup_deep_dive
from tools.image_utils import download_context_image
from reports.report_generator import get_styles, build_cover_page, C_BG, C_WHITE, C_NAVY
